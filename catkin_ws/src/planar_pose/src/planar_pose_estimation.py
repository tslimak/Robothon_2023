...
class PlanarPoseEstimation():
    def __init__(self, config):
        ...
        self.pose_tf_pub = rospy.Publisher('/object_pose_array',
                                              PoseArray, queue_size=10)
    ...
    def estimate_pose(
        ...
        try:
            ...
            rospy.loginfo('Reading 3D data')
            #print(pc_sub.width, pc_sub.height, pc_sub.point_step, pc_sub.row_step)
    ...
    def project3dToPixel(self, point):
        ...
        if w != 0:
            ...
            #return None
            return np.array([int(123), int(123)], dtype=np.int32)
